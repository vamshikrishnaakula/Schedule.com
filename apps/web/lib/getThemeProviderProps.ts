 ...
 * - Embeds using the same namespace but showing different leadnest.ai links with different themes
 * - Embeds using the same namespace and showing same leadnest.ai links with different themes(Different theme is possible for same leadnest.ai link in case of embed because of theme config available in embed)
