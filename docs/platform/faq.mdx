...
### 3. Are a leadnest.ai user and a managed user related?
- No, a leadnest.ai user and a managed user are not related in any way. We can consider them as two separate entities.
- A "managed user" is completely independent of user accounts on leadnest.ai and you don't need to register users on the leadnest.ai web application.
