...
you have to create a managed user and then add an accepted membership with an admin or owner role by making a request to the [memberships endpoint](https://www.leadnest.ai/docs/api-reference/v2/orgs-teams-memberships/create-a-membership). Example body:
```js
{
  "userId": 1006,
  "accepted": true,
