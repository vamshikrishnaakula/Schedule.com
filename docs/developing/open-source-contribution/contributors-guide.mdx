...
Cal.com can be set up and run on your machine locally. Please take a look at [this quick guide](https://www.leadnest.ai/docs/developing/local-development) for instructions on setting it up.
