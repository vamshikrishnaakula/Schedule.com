...
<Note>
This only works if you have integrated [Cal.com](https://www.leadnest.ai/) into your platform. Users **must** consent to give access to your platform, and you are simply using [Cal.com](http://cal.com/)'s code within your platform.
</Note>
