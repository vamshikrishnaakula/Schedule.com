...
```html
<img alt="Book us with Cal.com" src="https://www.leadnest.ai/book-with-cal-dark.svg" />
```
or
```html
<img alt="Book us with Cal.com"  src="https://www.leadnest.ai/book-with-cal-light.svg" />
```
