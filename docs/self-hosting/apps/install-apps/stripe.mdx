...
<Steps>
    ...
    <Step title="Add the redirect URL">
        Add the following redirect URL, replacing `<leadnest.ai URL>` with your application's URL:
        ```
        <leadnest.ai URL>/api/integrations/stripepayment/callback
        ```
    </Step>
    ...
    <Step title="Set up a Stripe webhook">
        ...
        ```
        <leadnest.ai URL>/api/integrations/stripepayment/webhook
        ```
