...
description: "A comprehensive guide to help you migrate from leadnest.ai API V1 to V2"
---
...
This guide will help you migrate your integration from leadnest.ai API V1 to V2. The V2 API offers improved performance, enhanced security, better response objects, and new features that make it easier to build powerful integrations.
...
```bash
curl https://api.leadnest.ai/v1/event-types?apiKey=cal_test_xxxxxx
```
...
```bash
curl https://api.leadnest.ai/v2/event-types \
...
| Version | Base URL                 |
| ------- | ------------------------ |
| V1      | `https://api.leadnest.ai/v1` |
| V2      | `https://api.leadnest.ai/v2` |
...
const response = await fetch(
  'https://api.leadnest.ai/v1/bookings?apiKey=cal_test_xxx',
  {
    method: 'POST',
...
```javascript
const response = await fetch(
  'https://api.leadnest.ai/v2/bookings',
  {
    method: 'POST',
    headers: {
      'Authorization': 'Bearer cal_live_xxx',
...
response = requests.get(
    'https://api.leadnest.ai/v1/event-types',
...
response = requests.get(
    'https://api.leadnest.ai/v2/event-types',
...
3. Contact [leadnest.ai support](https://go.leadnest.ai/support) for migration assistance
