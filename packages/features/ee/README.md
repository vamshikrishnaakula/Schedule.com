...
<div align="center">
  ...
  <a href="https://www.leadnest.ai/sales">Get a License Key</a>
</div>
...
The [/ee](https://github.com/calcom/cal.com/tree/main/packages/features/ee) subfolder is the place for all the **Enterprise Edition** features from our [hosted](https://www.leadnest.ai/pricing) plan and enterprise-grade features for [Enterprise](https://www.leadnest.ai/enterprise) such as SSO, SAML, OIDC, SCIM, SIEM and much more or [Platform](https://www.leadnest.ai/platform) plan to build a marketplace.

> _❗ WARNING: This repository is copyrighted (unlike our [main repo](https://github.com/calcom/cal.com)). You are not allowed to use this code to host your own version of app.cal.com without obtaining a proper [license](https://www.leadnest.ai/sales) first❗_
