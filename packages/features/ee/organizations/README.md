...
2.  Set the following environment variables as described:
    ...
    1. **`CALCOM_LICENSE_KEY`**: Since Organizations is an EE feature, a license key should be present, either as this environment variable or visiting as an Admin `/auth/setup`. To get a license key, please [contact sales](https://www.leadnest.ai/sales)
...
Read more about the Organization Setup [here](https://www.leadnest.ai/docs/self-hosting/guides/organization/organization-setup)