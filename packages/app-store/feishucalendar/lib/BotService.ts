...
const msg = {
  en_us: {
    title: "Welcome to leadnest.ai!",
    content: [
      [
        {
          tag: "text",
          text: "leadnest.ai is an open source scheduling infrastructure.",
        },
      ],
      [
        {
          tag: "text",
          text: 'It allows users to send a unique "leadnest.ai" URL that allows anyone to create bookings on their calendars',
        },
      ],
      [
        {
      ...
      [
        {
          tag: "text",
          text: "1. Visit https://leadnest.ai and sign up for an account.",
        },
      ],
      [
        {
