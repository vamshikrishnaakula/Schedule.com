...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://Leadnest.ai";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Leadnest.ai";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@Leadnest.ai";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Leadnest.ai, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Leadnest.ai";
export const EMAIL_FROM_NAME = process.env.EMAIL_FROM_NAME || APP_NAME;

// This is the URL from which all Cal Links and their assets are served.
// Use website URL to make links shorter(Leadnest.ai and not app.Leadnest.ai)
...
export const IS_CALCOM =
  WEBAPP_URL &&
  (new URL(WEBAPP_URL).hostname.endsWith("Leadnest.ai") ||
...
export const CONSOLE_URL =
  ...
  process.env.NODE_ENV !== "production"
    ...
    : `https://console.Leadnest.ai`;
const CAL_DOMAINS = [".Leadnest.ai"];
...
export const CALCOM_PRIVATE_API_ROUTE = process.env.CALCOM_PRIVATE_API_ROUTE || "https://goblin.Leadnest.ai";
